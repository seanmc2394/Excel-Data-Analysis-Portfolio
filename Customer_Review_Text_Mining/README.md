# Overview
This project analyses real customer feedback to find common themes and recurring words using Excel. The goal was to identify what guests talked about most, both good and bad, by extracting and counting keywords from comment data.
<br>
<br>
...
- Created a visual summary using charts and a word cloud to highlight the most common terms.
